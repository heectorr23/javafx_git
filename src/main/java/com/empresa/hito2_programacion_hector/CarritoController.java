...
public class CarritoController {
    ...
    @FXML
    private TableColumn<Pieza, Integer> selectedAnoFabricacionColumn;
    @FXML
    ...
    public void initialize() {
        ...
        selectedAnoFabricacionColumn.setCellValueFactory(new PropertyValueFactory<>("ano_fabricacion"));
